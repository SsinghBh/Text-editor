...
from tkinter import Image, Scrollbar, ttk
...
red_default_icon = tk.PhotoImage(file='icons2/red.png')
...
color_icons = (light_default_icon, light_plus_icon, dark_icon, red_default_icon, monokai_icon, night_blue_icon)
...
edit.add_command(label='Find', image=copy_icon, compound=tk.LEFT, accelerator='Ctrl+F', command=find_func)
